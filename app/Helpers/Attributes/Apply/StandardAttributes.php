 ...
 * They are readable by anyone, unless private family, then they are readable only to the user group members
 * They have no bounds
 */
class StandardAttributes
{
    const DEF = [
        ...
        //private info, can only be read by user's group members,
        User::SYSTEM_NAME . '.private_info' => [
            'name' => User::SYSTEM_NAME . '.private_info',
            'uuid' => '69adde62-5958-45c3-9566-5013f293f917',
            'internal_description' => 'Attributes having to do with describing',
            'parent_uuid' => '6ac886fb-d52f-46fa-b5db-a3d0a91e0b85',
            'validator' => null,
            'is_system_private' => false
        ],
        User::SYSTEM_NAME . '.private_info.name' => [
            'name' => User::SYSTEM_NAME . '.private_info.name',
            'uuid' => '09963b71-e8e9-41f3-b58f-95ea4c51fc38',
            'internal_description' => 'A name not restricted to the naming rules of the code',
            'parent_uuid' => '69adde62-5958-45c3-9566-5013f293f917',
            'validator' => null,
            'is_system_private' => false
        ],
        User::SYSTEM_NAME . '.private_info.email' => [
            'name' => User::SYSTEM_NAME . '.private_info.email',
            'uuid' => 'e3b2254c-3ebd-44c3-9cfb-406560a12880',
            'internal_description' => 'vaguely resembles email',
            'parent_uuid' => '69adde62-5958-45c3-9566-5013f293f917',
            'validator' => [StandardAttributes::class, 'validateEmail'],
        ...
        User::SYSTEM_NAME . '.private_info.phone_number' => [
            'name' => User::SYSTEM_NAME . '.private_info.phone_number',
            'uuid' => '620b02d6-a9d6-4159-83a4-fd926688bcac',
            'internal_description' => 'e.164 only',
            'parent_uuid' => '69adde62-5958-45c3-9566-5013f293f917',
            'validator' => [StandardAttributes::class, 'validatePhone'],
        ...
        User::SYSTEM_NAME . '.private_info.address' => [
            'name' => User::SYSTEM_NAME . '.private_info.address',
            'uuid' => '2b4b34f5-606f-47c0-8797-80f8ec38aed5',
            'internal_description' => 'any string',
            'parent_uuid' => '69adde62-5958-45c3-9566-5013f293f917',
            'validator' => null,
        ...
        User::SYSTEM_NAME . '.private_info.map_location' => [
            'name' => User::SYSTEM_NAME . '.private_info.map_location',
            'uuid' => 'de7c7ae8-1d8a-4c4a-a0ec-ba80ca21c980',
            'internal_description' => '2d map location',
            'parent_uuid' => '69adde62-5958-45c3-9566-5013f293f917',
            'validator' => [StandardAttributes::class, 'validateMapLocation'],
