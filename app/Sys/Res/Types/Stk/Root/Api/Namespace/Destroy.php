...
class Destroy extends Api\NamespaceApi implements ICommandCallable
{
    ...
    const PARENT_CLASSES = [
        ...
        Act\Cmd\Ns\NamespaceDestroyDo::class,
    ];
     ...
     * @throws \Throwable
     */
    public static function doDeletion(ChangeNamespacesParamData $params,
    ...
    : ChangeNamespacesParamData|Thang
    {
        ...
        Act\Cmd\Ns\NamespaceDestroyDo::makeTree(
            params: $params,
