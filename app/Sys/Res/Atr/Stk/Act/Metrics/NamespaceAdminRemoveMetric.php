...
class NamespaceAdminRemoveMetric extends BaseAttribute
{
    const UUID = '510ddcac-a8fb-4b09-8a9e-b619b0f847d5';
    const ATTRIBUTE_NAME = 'namespace_admin_remove_metric';
