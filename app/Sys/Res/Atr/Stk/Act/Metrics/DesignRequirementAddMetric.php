...
class DesignRequirementAddMetric extends BaseAttribute
{
    const UUID = '5f22650e-e609-401a-88db-f5abdf857cf7';
    const ATTRIBUTE_NAME = 'design_requirement_add_metric';
