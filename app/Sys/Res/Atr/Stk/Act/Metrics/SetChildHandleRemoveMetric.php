...
class SetChildHandleRemoveMetric extends BaseAttribute
{
    const UUID = '432bc570-8d23-44cb-a695-1c692302c5c4';
    const ATTRIBUTE_NAME = 'set_child_handle_remove_metric';
