...
class NewBuild
{
    ...
    const array TYPES = [
        ...
        Stk\Root\Evt\Element\LinkDestroyed::class,
        Stk\Root\Evt\Element\LinkDestroying::class,
        ...
        Stk\Root\Evt\Server\LivePermissionAdded::class,
        Stk\Root\Evt\Server\LivePermissionAdding::class,
        Stk\Root\Evt\Server\LivePermissionRemoved::class,
        Stk\Root\Evt\Server\LivePermissionRemoving::class,
        ...
        Stk\Root\Act\Cmd\Ele\MetaReadAttributes::class,
        Stk\Root\Act\Cmd\Ele\MetaWriteAttributes::class,
        ...
        Stk\Root\Act\Cmd\Ty\LivePermissionAdd::class,
        Stk\Root\Act\Cmd\Ty\LivePermissionRemove::class,
        ...
        Stk\Root\Api\Element\MetaRead::class,
        Stk\Root\Api\Element\MetaWrite::class,
        ...
        Stk\Root\Api\Type\AddPermission::class,
        ...
        Stk\Root\Api\Type\RemovePermission::class,
