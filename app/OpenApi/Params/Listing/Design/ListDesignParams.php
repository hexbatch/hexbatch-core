...
#[OA\Schema(schema: 'ListDesignParams')]
class ListDesignParams extends ShowDesignParams
{

    #[OA\Property(title: 'Namespace',description: 'The type is in this namespace. Can be uuid or name')]
