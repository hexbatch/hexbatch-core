...
class LinkerCollectionResponse extends ResultDataBase
{
    ...
    )
    {
        ...
        /** @var ElementSet[] $sets */
        $links = ElementLink::buildLink(linking_element_id: $linker_element->id, with_linker_element: true, with_linked_set: true)->cursorPaginate();
