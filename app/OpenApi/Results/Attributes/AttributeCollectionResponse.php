...
class AttributeCollectionResponse extends ResultDataBase
{
     ...
     */
    public function __construct($given_attributes,  int $attribute_levels = 0,int $owning_type_levels = 0,int $design_levels = 0)
    {
