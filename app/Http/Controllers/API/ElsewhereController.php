...
class ElsewhereController extends Controller {
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/give_credentials',
        operationId: 'core.elsewhere.give_credentials',
        description: "Can reset and send credentials to regisered server . This can be blocked by event",
        summary: 'Servers can renew credentials',
        responses: [
            new OA\Response( response: CodeOf::HTTP_NOT_IMPLEMENTED, description: 'Not yet implemented')
        ]
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/push_credentials',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/give_namespace',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/give_set',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/give_type',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/give_event',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/give_element',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/share_element',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/ask_element',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/ask_type',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/ask_namespace',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/push_element',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/push_set',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/push_namespace',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/push_type',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/push_event',
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/destroyed_element',
        operationId: 'core.elsewhere.destroyed_element',
        description: "We do record keeping, so if this is the record, event is called. ".
    ...
    #[OA\Post(
        path: '/api/v1/elsewhere/suspended_type',
    ...
    #[OA\Delete(
        path: '/api/v1/elsewhere/purge_elsewhere',
    ...
    #[OA\Get(
        path: '/api/v1/elsewhere/show_server',
        operationId: 'core.elsewhere.show_server',
