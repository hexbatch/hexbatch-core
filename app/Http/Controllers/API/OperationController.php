...
class OperationController extends Controller {
    ...
    #[OA\Post(
        path: '/api/v1/operations/unshift',
    ...
    #[OA\Post(
        path: '/api/v1/operations/combine',
