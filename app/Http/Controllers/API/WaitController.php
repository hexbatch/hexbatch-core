...
class WaitController extends Controller {
    ...
    #[OA\Post(
        path: '/api/v1/waits/create_master',
    ...
    #[OA\Post(
        path: '/api/v1/waits/update_master',
    ...
    #[OA\Post(
        path: '/api/v1/waits/reset_semaphore',
    ...
    #[OA\Post(
        path: '/api/v1/waits/ready_semaphore',
    ...
    #[OA\Get(
        path: '/api/v1/waits/show_master_run',
    ...
    #[OA\Get(
        path: '/api/v1/waits/list_masters',
    ...
    #[OA\Get(
        path: '/api/v1/waits/show_semaphore',
    ...
    #[OA\Get(
        path: '/api/v1/waits/list_semaphores',
    ...
    #[OA\Get(
        path: '/api/v1/waits/list_mutexes',
    ...
    #[OA\Post(
        path: '/api/v1/waits/wait_if_available',
    ...
    #[OA\Post(
        path: '/api/v1/waits/wait_for_any',
    ...
    #[OA\Post(
        path: '/api/v1/waits/wait_for_all',
    ...
    #[OA\Post(
        path: '/api/v1/waits/wait_for_mutex',
    ...
    #[OA\Post(
        path: '/api/v1/waits/wait_for_semaphore',
