...
class ElsewhereController extends Controller {
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/give_credentials',
        ...
        parameters: [
            ...
            new OA\PathParameter(  name: 'server', description: "The server",
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/push_credentials',
    ...
    #[OA\Patch(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/change_status',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/give_namespace',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/give_set',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/give_type',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/give_event',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/give_element',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/share_element',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/ask_element',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/ask_type',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/ask_set',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/ask_namespace',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/push_element',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/push_set',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/push_namespace',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/push_type',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/push_event',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/destroyed_element',
    ...
    #[OA\Post(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/suspended_type',
    ...
    #[OA\Delete(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/purge',
    ...
    #[OA\Get(
        path: '/api/v1/elsewhere/show/{server}',
    ...
    #[OA\Get(
        path: '/api/v1/{user_namespace}/elsewhere/{server}/show_admin',
