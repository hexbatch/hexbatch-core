...
enum TypeApiFollowup : string {
    ...
    case REMOTE_IN_PENDING = 'remote_in_pending';
    case REMOTE_IN_COMPLETED = 'remote_in_completed';
    case REMOTE_IN_ERROR = 'remote_in_error';
    case REMOTE_OUT_PENDING = 'remote_out_pending';
    case REMOTE_OUT_SUCCESS = 'remote_out_success';
    case REMOTE_OUT_ERROR = 'remote_out_error';
