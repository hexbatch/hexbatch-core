...
enum RuleTargetActionType: string
{
    ...
    case COMMAND_ASSIGN_USER_TO_EMPTY = 'command_assign_user_to_empty';
    case COMMAND_CREATE_ELEMENT = 'command_create_element';
    case COMMAND_DESTROY_ELEMENT = 'command_destroy_element';
    case COMMAND_GROUP_ADD_MEMBER = 'command_group_add_member';
    case COMMAND_GROUP_ADD_ADMIN = 'command_group_add_admin';
    case COMMAND_GROUP_REMOVE_MEMBER = 'command_group_remove_member';
    case COMMAND_GROUP_REMOVE_ADMIN = 'command_group_remove_admin';
